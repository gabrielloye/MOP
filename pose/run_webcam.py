...
def get_model():
    ...
    net = CoordRegressionNetwork(n_locations=16, backbone='mobilenetv2').to("cpu")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='mobilenetv2', choices=['mobilenetv2', 'resnet18', 'shufflenetv2', 'squeezenet'])
    parser.add_argument('--inp_dim', type=int, default=224, help='input size')
    parser.add_argument('--camera', type=str, default="http://192.168.0.196:4747/video")
